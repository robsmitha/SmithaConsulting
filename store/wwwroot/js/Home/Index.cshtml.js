...
function LoadCart(orderId) {
    $.get('/Home/LoadCart/', { orderId: orderId }, function (data) {
        $('#div_cart').html(data)
    })
}

function ListRegister(orderId) {
    $.get('/Home/List/', { orderId: orderId }, function (data) {
        $('#div_list').html(data)
    })
}

function EditRegister(itemId, orderId) {
    $.get('/Home/Edit/', { itemId: itemId, orderId: orderId }, function (data) {
