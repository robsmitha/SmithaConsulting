...
namespace Administration.Controllers
{
    public class PaymentsController : BaseController
    {
        ...
        public PaymentsController(OperationsContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            var DbArchitecture = _context.Payments.Include(p => p.Authorization).Include(p => p.Order).Include(p => p.PaymentStatusType).Include(p => p.PaymentType);
