...
namespace Administration.Controllers
{
    public class ItemTypesController : BaseController
    {
        ...
        public ItemTypesController(OperationsContext context) : base(context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,ID,CreatedAt,Active,ModifiedTime")] ItemType itemType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Description,ID,CreatedAt,Active,ModifiedTime")] ItemType itemType)
        {
            if (id != itemType.ID)
            {
                return NotFound();
