...
namespace Administration.Controllers
{
    public class MerchantUsersController : BaseController
    {
        ...
        public MerchantUsersController(OperationsContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            var DbArchitecture = _context.MerchantUsers.Include(m => m.Merchant).Include(m => m.Role).Include(m => m.User);
